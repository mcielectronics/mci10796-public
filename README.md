...
Este revisa que todas las conexiones estén bien hechas. En el caso de que no sea así, indica en donde podría estar el error.
...
# Registro de direcciones útiles
REG_VERSION = 0x42
REG_OPMODE = 0x01
REG_IRQ_FLAGS = 0x12
...
def diagnostico_sx1276():
    ...
    # Probar escritura/lectura RegOpMode
